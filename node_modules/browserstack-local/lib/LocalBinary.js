...
function LocalBinary(){
  ...
  console.log("GOT http path " + this.httpPath);
  ...
  this.binaryPath = function(conf, callback){
    ...
    if(this.checkPath(binaryPath, fs.X_OK)){
      console.log("CHECK PATH WAS OKAY");
      callback(binaryPath);
    } else {
      console.log("CHECK PATH WAS NOT OKAY");
